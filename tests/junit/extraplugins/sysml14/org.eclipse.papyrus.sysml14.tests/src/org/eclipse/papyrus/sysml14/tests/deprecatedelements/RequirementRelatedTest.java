...
/**
 * A test case for the model object '<em><b>Requirement Related</b></em>'.
 * <p>
...
public class RequirementRelatedTest extends AbstractPapyrusTest {
	...
	public void setUp() throws Exception {
		setFixture(DeprecatedelementsFactory.eINSTANCE.createRequirementRelated());
		...
		default_reqR = (RequirementRelated)StereotypeApplicationHelper.INSTANCE.applyStereotype(defaultClass, DeprecatedelementsPackage.eINSTANCE.getRequirementRelated());
		...
		traced_reqR = (RequirementRelated)StereotypeApplicationHelper.INSTANCE.applyStereotype(traced, DeprecatedelementsPackage.eINSTANCE.getRequirementRelated());
		...
		copy_reqR = (RequirementRelated)StereotypeApplicationHelper.INSTANCE.applyStereotype(copy, DeprecatedelementsPackage.eINSTANCE.getRequirementRelated());
		...
		satisfying_reqR = (RequirementRelated)StereotypeApplicationHelper.INSTANCE.applyStereotype(satisfying, DeprecatedelementsPackage.eINSTANCE.getRequirementRelated());
		...
		verifying_reqR = (RequirementRelated)StereotypeApplicationHelper.INSTANCE.applyStereotype(verifying, DeprecatedelementsPackage.eINSTANCE.getRequirementRelated());
		...
		refining_reqR = (RequirementRelated)StereotypeApplicationHelper.INSTANCE.applyStereotype(refining, DeprecatedelementsPackage.eINSTANCE.getRequirementRelated());
	 ...
	 * <em>Satisfies</em>}' feature getter.
	 *
	 ...
	 * <em>Traced From</em>}' feature getter.
	 *
