...
public class RequirementTest extends AbstractPapyrusTest {
	...
	public void setUp() throws Exception {
		...
		testCase1 = (org.eclipse.papyrus.sysml14.requirements.TestCase)StereotypeApplicationHelper.INSTANCE.applyStereotype(op1, RequirementsPackage.eINSTANCE.getTestCase());
		testCase2 = (org.eclipse.papyrus.sysml14.requirements.TestCase)StereotypeApplicationHelper.INSTANCE.applyStereotype(op2, RequirementsPackage.eINSTANCE.getTestCase());
