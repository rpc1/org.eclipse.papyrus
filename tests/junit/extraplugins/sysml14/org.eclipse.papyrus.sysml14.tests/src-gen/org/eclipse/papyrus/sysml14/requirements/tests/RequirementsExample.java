...
public class RequirementsExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.requirements")); //$NON-NLS-1$
				DeriveReqt root = RequirementsFactory.eINSTANCE.createDeriveReqt();
