...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>portandflows</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class PortandflowsExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.portandflows")); //$NON-NLS-1$
				ItemFlow root = PortandflowsFactory.eINSTANCE.createItemFlow();
