 ...
 */
package org.eclipse.papyrus.sysml14.constraintblocks.tests;
...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>constraintblocks</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class ConstraintblocksExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(ConstraintblocksPackage.eNS_URI, 
			 ConstraintblocksPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.constraintblocks")); //$NON-NLS-1$
				ConstraintBlock root = ConstraintblocksFactory.eINSTANCE.createConstraintBlock();
