 ...
 */
package org.eclipse.papyrus.sysml14.deprecatedelements.tests;
...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>deprecatedelements</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class DeprecatedelementsExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(DeprecatedelementsPackage.eNS_URI, 
			 DeprecatedelementsPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.deprecatedelements")); //$NON-NLS-1$
				FlowPort root = DeprecatedelementsFactory.eINSTANCE.createFlowPort();
