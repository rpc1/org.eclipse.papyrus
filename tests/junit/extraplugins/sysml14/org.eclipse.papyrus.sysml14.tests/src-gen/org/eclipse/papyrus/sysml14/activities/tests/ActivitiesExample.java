...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>activities</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class ActivitiesExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.activities")); //$NON-NLS-1$
				Overwrite root = ActivitiesFactory.eINSTANCE.createOverwrite();
