...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>allocations</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class AllocationsExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.allocations")); //$NON-NLS-1$
				AllocateActivityPartition root = AllocationsFactory.eINSTANCE.createAllocateActivityPartition();
