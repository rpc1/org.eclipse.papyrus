...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>blocks</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class BlocksExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.blocks")); //$NON-NLS-1$
				ValueType root = BlocksFactory.eINSTANCE.createValueType();
