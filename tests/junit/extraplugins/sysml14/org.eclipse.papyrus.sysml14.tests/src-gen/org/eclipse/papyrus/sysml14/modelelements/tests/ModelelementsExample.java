...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>modelelements</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class ModelelementsExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.modelelements")); //$NON-NLS-1$
				Rationale root = ModelelementsFactory.eINSTANCE.createRationale();
