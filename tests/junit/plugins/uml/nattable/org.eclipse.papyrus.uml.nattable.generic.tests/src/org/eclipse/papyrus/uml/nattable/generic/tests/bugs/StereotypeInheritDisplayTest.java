...
public class StereotypeInheritDisplayTest extends AbstractPapyrusTest {
	...
	protected void checkTableContent(final INattableModelManager currentManager) throws Exception {
		...
		Assert.assertEquals("The first cell editor must be an UML_EDITOR_CONFIG", "UML_EDITOR_CONFIG0", //$NON-NLS-1$ //$NON-NLS-2$
		...
		Assert.assertEquals("The second cell editor must be an UML_EDITOR_CONFIG", "UML_EDITOR_CONFIG1", //$NON-NLS-1$ //$NON-NLS-2$
		...
		Assert.assertEquals("The third cell editor must be an UML_EDITOR_CONFIG", "UML_EDITOR_CONFIG2", //$NON-NLS-1$ //$NON-NLS-2$
		...
		Assert.assertEquals("The fourth cell editor must be an UML_EDITOR_CONFIG", "UML_EDITOR_CONFIG3", //$NON-NLS-1$ //$NON-NLS-2$
