...
import org.eclipse.papyrus.infra.elementtypesconfigurations.emf.setvaluesadviceconfiguration.util.SetValuesAdviceConfigurationSwitch;
...
public class FeatureValueUtils {
	...
	public static Object getValue(final EObject elementToConfigure, final EStructuralFeature feature, final FeatureValue featureValue) {
		...
		Object result = new SetValuesAdviceConfigurationSwitch<Object>() {
			/**
			 * {@inheritDoc}
			 */
			@Override
