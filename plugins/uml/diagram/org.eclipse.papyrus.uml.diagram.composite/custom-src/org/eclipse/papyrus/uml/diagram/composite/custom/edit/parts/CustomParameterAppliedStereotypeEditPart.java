...
/**
 * The custom edit policy for the parameter applied stereotype.
 */
public class CustomParameterAppliedStereotypeEditPart extends ParameterAppliedStereotypeEditPart {
	 ...
	 *            The view
	 */
	public CustomParameterAppliedStereotypeEditPart(final View view) {
		super(view);
	}
