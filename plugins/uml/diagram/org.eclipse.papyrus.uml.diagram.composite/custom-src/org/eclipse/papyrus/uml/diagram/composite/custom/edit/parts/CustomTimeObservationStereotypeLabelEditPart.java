 ...
 */
public class CustomTimeObservationStereotypeLabelEditPart extends TimeObservationStereotypeLabelEditPart {
	 ...
	 *            The view
	 */
	public CustomTimeObservationStereotypeLabelEditPart(final View view) {
		super(view);
	}
