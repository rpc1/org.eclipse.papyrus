 ...
 * @generated
 */
public class ExpressionEditPart extends RoundedCompartmentEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if(childEditPart instanceof ExpressionNameEditPart) {
			((ExpressionNameEditPart)childEditPart).setLabel(getPrimaryShape().getNameLabel());
			return true;
		}
		return false;
	}
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if(borderItemEditPart instanceof ExpressionFloatingLabelEditPart) {
