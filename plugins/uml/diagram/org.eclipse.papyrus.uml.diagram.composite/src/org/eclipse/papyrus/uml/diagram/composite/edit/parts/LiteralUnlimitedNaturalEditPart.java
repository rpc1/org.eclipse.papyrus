 ...
 * @generated
 */
public class LiteralUnlimitedNaturalEditPart extends RoundedCompartmentEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if(childEditPart instanceof LiteralUnlimitedNaturalNameEditPart) {
			((LiteralUnlimitedNaturalNameEditPart)childEditPart).setLabel(getPrimaryShape().getNameLabel());
			return true;
		}
		return false;
	}
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if(borderItemEditPart instanceof LiteralUnlimitedNaturalFloatingLabelEditPart) {
