 ...
 * @generated
 */
public class LiteralIntegerEditPart extends RoundedCompartmentEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if(childEditPart instanceof LiteralIntegerNameEditPart) {
			((LiteralIntegerNameEditPart)childEditPart).setLabel(getPrimaryShape().getNameLabel());
			return true;
		}
		return false;
	}
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if(borderItemEditPart instanceof LiteralIntegerFloatingLabelEditPart) {
