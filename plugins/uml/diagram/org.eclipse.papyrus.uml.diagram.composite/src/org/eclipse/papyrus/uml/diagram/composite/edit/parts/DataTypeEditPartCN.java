 ...
 * @generated
 */
public class DataTypeEditPartCN extends RoundedCompartmentEditPart {
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if(borderItemEditPart instanceof DataTypeFloatingLabelEditPartCN) {
	...
	public EditPart getTargetEditPart(Request request) {
		if(request instanceof CreateViewAndElementRequest) {
			...
			if(UMLElementTypes.isKindOf(type, UMLElementTypes.Property_3101)) {
				return getChildBySemanticHint(UMLVisualIDRegistry.getType(DataTypeAttributeCompartmentEditPartCN.VISUAL_ID));
			}
			if(UMLElementTypes.isKindOf(type, UMLElementTypes.Operation_3102)) {
