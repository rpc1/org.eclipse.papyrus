 ...
 * @generated
 */
public class StringExpressionEditPart extends RoundedCompartmentEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if(childEditPart instanceof StringExpressionNameEditPart) {
			((StringExpressionNameEditPart)childEditPart).setLabel(getPrimaryShape().getNameLabel());
			return true;
		}
		return false;
	}
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if(borderItemEditPart instanceof StringExpressionFloatingLabelEditPart) {
