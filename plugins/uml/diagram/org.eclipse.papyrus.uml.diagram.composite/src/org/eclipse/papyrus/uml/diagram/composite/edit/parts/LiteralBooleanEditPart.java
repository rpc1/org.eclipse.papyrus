 ...
 * @generated
 */
public class LiteralBooleanEditPart extends RoundedCompartmentEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if(childEditPart instanceof LiteralBooleanNameEditPart) {
			((LiteralBooleanNameEditPart)childEditPart).setLabel(getPrimaryShape().getNameLabel());
			return true;
		}
		return false;
	}
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if(borderItemEditPart instanceof LiteralBooleanFloatingLabelEditPart) {
