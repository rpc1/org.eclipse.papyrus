 ...
 * @generated
 */
public class ConstraintInComponentEditPart extends AbstractConstraintEditPart {
	 ...
	 * @generated
	 */
	public ConstraintInComponentEditPart(View view) {
		super(view);
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ConstraintInComponentNameEditPart) {
			((ConstraintInComponentNameEditPart) childEditPart).setLabel(getPrimaryShape().getNameLabel());
			return true;
		}
		if (childEditPart instanceof ConstraintBodyInCEditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(ConstraintInComponentNameEditPart.VISUAL_ID));
	}
}
