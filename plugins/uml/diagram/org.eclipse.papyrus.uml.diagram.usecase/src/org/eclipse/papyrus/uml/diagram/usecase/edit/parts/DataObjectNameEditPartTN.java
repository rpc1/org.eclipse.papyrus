 ...
 * @generated
 */
public class DataObjectNameEditPartTN extends
		PapyrusLabelEditPart
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.papyrus.uml.diagram.usecase.edit.parts.DataObjectNameEditPartTN.VISUAL_ID), new Point(0, 0));
	}

	/**
	 * @generated
	 */
	public DataObjectNameEditPartTN(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.DataObject_2023, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.uml.diagram.usecase.edit.parts.DataObjectNameEditPartTN.VISUAL_ID));
		}
		return parser;
	}
