 ...
 * @generated
 */
public class CommentEditPartTN extends AbstractCommentEditPart {
	 ...
	 * @generated
	 */
	public CommentEditPartTN(View view) {
		super(view);
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CommentBodyEditPartTN) {
			((CommentBodyEditPartTN) childEditPart).setLabel(getPrimaryShape().getCornerBentFigure());
			return true;
		}
