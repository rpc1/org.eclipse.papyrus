 ...
 * @generated
 */
public class DataObjectInPackageEditPart extends RoundedCompartmentEditPart {
	 ...
	 * @generated
	 */
	public DataObjectInPackageEditPart(View view) {
		super(view);
	}
	...
	**/
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof DataObjectInPackageNameEditPart || borderItemEditPart instanceof DataObjectInPackageAppliedStereotypeEditPart) {
			BorderItemLocator locator = new BorderItemLocator(getMainFigure(), PositionConstants.SOUTH);
			locator.setBorderItemOffset(new Dimension(-20, -20));
			borderItemContainer.add(borderItemEditPart.getFigure(), locator);
		} else if (borderItemEditPart instanceof DataObjectQualifiedNameInPEditPart) {
			IBorderItemLocator locator = new ExternalLabelPositionLocator(getMainFigure());
			borderItemContainer.add(borderItemEditPart.getFigure(), locator);
		} else if (borderItemEditPart instanceof DataObjectInPackageFloatingLabelEditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(DataObjectInPackageNameEditPart.VISUAL_ID));
	}
