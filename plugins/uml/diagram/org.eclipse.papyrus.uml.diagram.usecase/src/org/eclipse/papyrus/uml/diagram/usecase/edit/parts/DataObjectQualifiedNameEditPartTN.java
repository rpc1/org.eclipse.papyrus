 ...
 * @generated
 */
public class DataObjectQualifiedNameEditPartTN extends PapyrusLabelEditPart
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.papyrus.uml.diagram.usecase.edit.parts.DataObjectQualifiedNameEditPartTN.VISUAL_ID), new Point(0, 0));
	}

	/**
	 * @generated
	 */
	public DataObjectQualifiedNameEditPartTN(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.DataObject_2023, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.uml.diagram.usecase.edit.parts.DataObjectQualifiedNameEditPartTN.VISUAL_ID));
		}
		return parser;
	}
