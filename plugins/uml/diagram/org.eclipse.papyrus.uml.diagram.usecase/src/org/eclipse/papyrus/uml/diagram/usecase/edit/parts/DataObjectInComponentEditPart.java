 ...
 * @generated
 */
public class DataObjectInComponentEditPart extends RoundedCompartmentEditPart {
	 ...
	 * @generated
	 */
	public DataObjectInComponentEditPart(View view) {
		super(view);
	}
	...
	**/
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof DataObjectInComponentNameEditPart || borderItemEditPart instanceof DataObjectInComponentAppliedStereotypeEditPart) {
			BorderItemLocator locator = new BorderItemLocator(getMainFigure(), PositionConstants.SOUTH);
			locator.setBorderItemOffset(new Dimension(-20, -20));
			borderItemContainer.add(borderItemEditPart.getFigure(), locator);
		} else if (borderItemEditPart instanceof DataObjectQualifiedNameInCEditPart) {
			IBorderItemLocator locator = new ExternalLabelPositionLocator(getMainFigure());
			borderItemContainer.add(borderItemEditPart.getFigure(), locator);
		} else if (borderItemEditPart instanceof DataObjectInComponentFloatingLabelEditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(DataObjectInComponentNameEditPart.VISUAL_ID));
	}
