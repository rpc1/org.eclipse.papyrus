 ...
 * @generated
 */
public class ConstraintInPackageEditPart extends AbstractConstraintEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ConstraintInPackageNameEditPart) {
			((ConstraintInPackageNameEditPart) childEditPart).setLabel(getPrimaryShape().getNameLabel());
			return true;
		}
		if (childEditPart instanceof ConstraintBodyInPEditPart) {
			((ConstraintBodyInPEditPart) childEditPart).setLabel(getPrimaryShape().getConstraintFigure());
			return true;
		}
