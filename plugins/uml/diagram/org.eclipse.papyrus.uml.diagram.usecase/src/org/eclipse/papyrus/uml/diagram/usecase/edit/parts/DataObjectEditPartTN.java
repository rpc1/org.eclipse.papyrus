 ...
 * @generated
 */
public class DataObjectEditPartTN extends RoundedCompartmentEditPart {
	 ...
	 * @generated
	 */
	public DataObjectEditPartTN(View view) {
		super(view);
	}
	...
	**/
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof DataObjectNameEditPartTN || borderItemEditPart instanceof DataObjectAppliedStereotypeEditPartTN || borderItemEditPart instanceof DataObjectQualifiedNameEditPartTN
				|| borderItemEditPart instanceof DataObjectFloatingLabelEditPartTN) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(DataObjectNameEditPartTN.VISUAL_ID));
	}
