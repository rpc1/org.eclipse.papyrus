 ...
 * uses of this policy in {@link org.eclipse.papyrus.uml.diagram.activity.edit.policies.CompartmentXYLayoutEditPolicy} or in {@link org.eclipse.papyrus.uml.diagram.activity.edit.parts.ActivityPartitionActivityPartitionContentCompartmentEditPart}
 *
...
public class XYLayoutEditGroupPolicy extends XYLayoutEditPolicy {
	...
	/**
	 * Return true except if the request is a create request in which {@link CreateInGroupEditPolicy#OLD_PARENT} and {@link CommandsUtils#NEW_PARENT_HOST} are set and are different
	 *
	 * @param req
	 *            The global request
	 * @param getHost
