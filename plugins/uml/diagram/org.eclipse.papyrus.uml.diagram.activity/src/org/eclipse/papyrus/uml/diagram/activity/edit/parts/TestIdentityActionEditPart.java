 ...
 * @generated
 */
public class TestIdentityActionEditPart extends RoundedCompartmentEditPart {
	 ...
	 * @generated
	 */
	public TestIdentityActionEditPart(View view) {
		super(view);
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof TestIdentityActionNameEditPart) {
			((TestIdentityActionNameEditPart) childEditPart).setLabel(getPrimaryShape().getNameLabel());
			return true;
		}
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof TestIdentityActionFloatingNameEditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(TestIdentityActionNameEditPart.VISUAL_ID));
	}
}
