 ...
 * @generated
 */
public class StartClassifierBehaviorActionNameEditPart extends PapyrusCompartmentEditPart implements ITextAwareEditPart, IControlParserForDirectEdit {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 5202;
	 ...
	 * @generated
	 */
	public StartClassifierBehaviorActionNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.StartClassifierBehaviorAction_3124, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.uml.diagram.activity.edit.parts.StartClassifierBehaviorActionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
