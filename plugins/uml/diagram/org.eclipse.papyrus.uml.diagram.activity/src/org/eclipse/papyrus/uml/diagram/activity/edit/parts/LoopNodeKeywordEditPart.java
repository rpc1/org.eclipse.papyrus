 ...
 * @generated
 */
public class LoopNodeKeywordEditPart extends PapyrusCompartmentEditPart implements ITextAwareEditPart, IControlParserForDirectEdit {
	...
	public LoopNodeKeywordEditPart(View view) {
		...
		preferenceListener = new IPropertyChangeListener() {
			...
			public void propertyChange(PropertyChangeEvent event) {
				if (IActivityPreferenceConstants.PREF_STRUCTURED_SPECIFIC_KEYWORD_DISPLAY_LOOP_NODE.equals(event.getProperty())) {
					if (getFigure() != null) {
						refreshLabel();
					}
				}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.LoopNode_3071, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.uml.diagram.activity.edit.parts.LoopNodeKeywordEditPart.VISUAL_ID));
		}
		return parser;
	}
