 ...
 * @generated
 */
public class InputPinInCreateLinkObjectActionAsInputValueEditPart extends AbstractPinEditPart {
	 ...
	 * @generated
	 */
	public InputPinInCreateLinkObjectActionAsInputValueEditPart(View view) {
		super(view);
	}
	...
	**/
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		...
		} else if(borderItemEditPart instanceof InputPinInCreateLinkObjectActionAsInputValueAppliedStereotypeLabelEditPart) {
			IBorderItemLocator locator = new ExternalLabelPositionLocator(getMainFigure());
			borderItemContainer.add(borderItemEditPart.getFigure(), locator);
		} else {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(InputPinInCreateLinkObjectActionAsInputValueLabelEditPart.VISUAL_ID));
	}
}
