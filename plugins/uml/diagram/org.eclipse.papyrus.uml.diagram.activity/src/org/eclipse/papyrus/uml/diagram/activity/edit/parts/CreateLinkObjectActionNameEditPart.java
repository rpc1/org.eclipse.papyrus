 ...
 * @generated
 */
public class CreateLinkObjectActionNameEditPart extends PapyrusCompartmentEditPart implements ITextAwareEditPart, IControlParserForDirectEdit {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 5406;
	 ...
	 * @generated
	 */
	public CreateLinkObjectActionNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.CreateLinkObjectAction_3198, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.uml.diagram.activity.edit.parts.CreateLinkObjectActionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
