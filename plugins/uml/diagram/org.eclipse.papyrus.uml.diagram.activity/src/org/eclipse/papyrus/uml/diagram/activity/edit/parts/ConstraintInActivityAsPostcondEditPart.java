...
import org.eclipse.papyrus.uml.diagram.activity.edit.policies.UMLTextNonResizableEditPolicy;
 ...
 * @generated
 */
public class ConstraintInActivityAsPostcondEditPart extends CompartmentEditPart implements ITextAwareEditPart, IPrimaryEditPart, IControlParserForDirectEdit {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Constraint_3003, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.uml.diagram.activity.edit.parts.ConstraintInActivityAsPostcondEditPart.VISUAL_ID));
		}
		return parser;
	}
