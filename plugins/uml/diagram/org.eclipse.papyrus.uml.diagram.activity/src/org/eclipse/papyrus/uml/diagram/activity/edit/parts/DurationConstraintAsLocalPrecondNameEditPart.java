 ...
 * @generated
 */
public class DurationConstraintAsLocalPrecondNameEditPart extends PapyrusCompartmentEditPart implements ITextAwareEditPart, IControlParserForDirectEdit {
	 ...
	 * @generated
	 */
	public DurationConstraintAsLocalPrecondNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.DurationConstraint_3034, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.uml.diagram.activity.edit.parts.DurationConstraintAsLocalPrecondNameEditPart.VISUAL_ID));
		}
		return parser;
	}
