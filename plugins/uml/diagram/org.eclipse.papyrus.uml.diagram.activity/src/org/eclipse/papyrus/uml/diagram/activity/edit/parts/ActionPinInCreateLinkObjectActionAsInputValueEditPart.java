 ...
 * @generated
 */
public class ActionPinInCreateLinkObjectActionAsInputValueEditPart extends AbstractPinEditPart {
	 ...
	 * @generated
	 */
	public ActionPinInCreateLinkObjectActionAsInputValueEditPart(View view) {
		super(view);
	}
	...
	**/
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if(borderItemEditPart instanceof ActionPinInCreateLinkObjectActionAsInputValueLabelEditPart) {
			IBorderItemLocator locator = new ExternalLabelPositionLocator(getMainFigure());
			borderItemContainer.add(borderItemEditPart.getFigure(), locator);
		} else if(borderItemEditPart instanceof ActionPinInCreateLinkObjectActionAsInputValueValueEditPart) {
			IBorderItemLocator locator = new ExternalLabelPositionLocator(getMainFigure());
			borderItemContainer.add(borderItemEditPart.getFigure(), locator);
		} else if(borderItemEditPart instanceof ActionPinInCreateLinkObjectActionAsInputValueAppliedStereotypeLabelEditPart) {
			IBorderItemLocator locator = new ExternalLabelPositionLocator(getMainFigure());
			borderItemContainer.add(borderItemEditPart.getFigure(), locator);
		} else {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(ActionPinInCreateLinkObjectActionAsInputValueLabelEditPart.VISUAL_ID));
	}
}
