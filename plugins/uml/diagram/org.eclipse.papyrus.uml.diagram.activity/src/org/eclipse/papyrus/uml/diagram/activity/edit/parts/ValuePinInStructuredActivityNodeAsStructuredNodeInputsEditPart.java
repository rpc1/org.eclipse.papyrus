 ...
 * @generated
 */
public class ValuePinInStructuredActivityNodeAsStructuredNodeInputsEditPart extends AbstractPinEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 3189;
	 ...
	 * @generated
	 */
	public ValuePinInStructuredActivityNodeAsStructuredNodeInputsEditPart(View view) {
		super(view);
	}
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof ValuePinInStructuredActivityNodeAsStructuredNodeInputsLabelEditPart) {
			IBorderItemLocator locator = new ExternalLabelPositionLocator(getMainFigure());
			borderItemContainer.add(borderItemEditPart.getFigure(), locator);
		} else if (borderItemEditPart instanceof ValuePinInStructuredActivityNodeAsStructuredNodeInputsValueEditPart) {
			IBorderItemLocator locator = new ExternalLabelPositionLocator(getMainFigure());
			borderItemContainer.add(borderItemEditPart.getFigure(), locator);
		} else if (borderItemEditPart instanceof ValuePinInStructuredActivityNodeAsStructuredNodeInputsAppliedStereotypeEditPart) {
			IBorderItemLocator locator = new ExternalLabelPositionLocator(getMainFigure());
			borderItemContainer.add(borderItemEditPart.getFigure(), locator);
		} else {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(ValuePinInStructuredActivityNodeAsStructuredNodeInputsLabelEditPart.VISUAL_ID));
	}
}
