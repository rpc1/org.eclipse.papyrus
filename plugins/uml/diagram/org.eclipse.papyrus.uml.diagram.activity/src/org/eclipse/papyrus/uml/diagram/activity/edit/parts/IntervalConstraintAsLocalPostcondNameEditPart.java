 ...
 * @generated
 */
public class IntervalConstraintAsLocalPostcondNameEditPart extends PapyrusCompartmentEditPart implements ITextAwareEditPart, IControlParserForDirectEdit {
	 ...
	 * @generated
	 */
	public IntervalConstraintAsLocalPostcondNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.IntervalConstraint_3033, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.uml.diagram.activity.edit.parts.IntervalConstraintAsLocalPostcondNameEditPart.VISUAL_ID));
		}
		return parser;
	}
