 ...
 * @generated
 */
public class ExpansionRegionKeywordEditPart extends PapyrusCompartmentEditPart implements ITextAwareEditPart, IControlParserForDirectEdit {
	 ...
	 * @generated
	 */
	public ExpansionRegionKeywordEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.ExpansionRegion_3070, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.uml.diagram.activity.edit.parts.ExpansionRegionKeywordEditPart.VISUAL_ID));
		}
		return parser;
	}
