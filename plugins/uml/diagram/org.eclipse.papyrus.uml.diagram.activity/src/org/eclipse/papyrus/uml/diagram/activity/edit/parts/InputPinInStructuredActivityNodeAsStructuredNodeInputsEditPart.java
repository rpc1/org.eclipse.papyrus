 ...
 * @generated
 */
public class InputPinInStructuredActivityNodeAsStructuredNodeInputsEditPart extends AbstractPinEditPart {
	 ...
	 * @generated
	 */
	public InputPinInStructuredActivityNodeAsStructuredNodeInputsEditPart(View view) {
		super(view);
	}
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof InputPinInStructuredActivityNodeAsStructuredNodeInputsLabelEditPart) {
			IBorderItemLocator locator = new ExternalLabelPositionLocator(getMainFigure());
			borderItemContainer.add(borderItemEditPart.getFigure(), locator);
		} else if (borderItemEditPart instanceof InputPinInStructuredActivityNodeAsStructuredNodeInputsAppliedStereotypeEditPart) {
			IBorderItemLocator locator = new ExternalLabelPositionLocator(getMainFigure());
			borderItemContainer.add(borderItemEditPart.getFigure(), locator);
		} else {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(InputPinInStructuredActivityNodeAsStructuredNodeInputsLabelEditPart.VISUAL_ID));
	}
}
