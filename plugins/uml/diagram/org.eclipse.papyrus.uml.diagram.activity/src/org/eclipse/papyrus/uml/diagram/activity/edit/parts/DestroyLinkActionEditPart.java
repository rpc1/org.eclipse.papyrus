 ...
 * @generated
 */
public class DestroyLinkActionEditPart extends RoundedCompartmentEditPart {
	 ...
	 * @generated
	 */
	public DestroyLinkActionEditPart(View view) {
		super(view);
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DestroyLinkActionNameEditPart) {
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof DestroyLinkActionFloatingNameEditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(DestroyLinkActionNameEditPart.VISUAL_ID));
	}
}
