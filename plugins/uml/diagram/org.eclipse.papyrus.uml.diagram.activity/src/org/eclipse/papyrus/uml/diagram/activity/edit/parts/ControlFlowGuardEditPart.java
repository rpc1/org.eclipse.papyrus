 ...
 * @generated
 */
public class ControlFlowGuardEditPart extends PapyrusLabelEditPart implements ITextAwareEditPart, IControlParserForDirectEdit, ILabelRoleProvider {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.papyrus.uml.diagram.activity.edit.parts.ControlFlowGuardEditPart.VISUAL_ID), new Point(0, 20));
	}

	/**
	 * @generated
	 */
	public ControlFlowGuardEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.ControlFlow_4004, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.uml.diagram.activity.edit.parts.ControlFlowGuardEditPart.VISUAL_ID));
		}
		return parser;
	}
