...
public class UMLVisualIDRegistry {
	...
	public static int getNodeVisualID(View containerView, EObject domainElement) {
		...
		case ConditionalNodeEditPart.VISUAL_ID:
			if (UMLPackage.eINSTANCE.getInputPin().isSuperTypeOf(domainElement.eClass()) && isInputPin_3188((InputPin) domainElement)) {
				return InputPinInStructuredActivityNodeAsStructuredNodeInputsEditPart.VISUAL_ID;
			}
			if (UMLPackage.eINSTANCE.getValuePin().isSuperTypeOf(domainElement.eClass()) && isValuePin_3189((ValuePin) domainElement)) {
				return ValuePinInStructuredActivityNodeAsStructuredNodeInputsEditPart.VISUAL_ID;
			}
			if (UMLPackage.eINSTANCE.getActionInputPin().isSuperTypeOf(domainElement.eClass()) && isActionInputPin_3190((ActionInputPin) domainElement)) {
		...
		case LoopNodeEditPart.VISUAL_ID:
			if (UMLPackage.eINSTANCE.getInputPin().isSuperTypeOf(domainElement.eClass()) && isInputPin_3105((InputPin) domainElement)) {
			...
			if (UMLPackage.eINSTANCE.getOutputPin().isSuperTypeOf(domainElement.eClass()) && isOutputPin_3109((OutputPin) domainElement)) {
				return OutputPinInLoopNodeAsBodyOutputEditPart.VISUAL_ID;
			}
			if (UMLPackage.eINSTANCE.getOutputPin().isSuperTypeOf(domainElement.eClass()) && isOutputPin_3110((OutputPin) domainElement)) {
				return OutputPinInLoopNodeAsLoopVariableEditPart.VISUAL_ID;
			}
			if (UMLPackage.eINSTANCE.getOutputPin().isSuperTypeOf(domainElement.eClass()) && isOutputPin_3111((OutputPin) domainElement)) {
		...
		case AddStructuralFeatureValueActionEditPart.VISUAL_ID:
			...
			if (UMLPackage.eINSTANCE.getInputPin().isSuperTypeOf(domainElement.eClass()) && isInputPin_3181((InputPin) domainElement)) {
				return InputPinInAddStructuralFeatureValueActionAsInserAtEditPart.VISUAL_ID;
			}
			if (UMLPackage.eINSTANCE.getValuePin().isSuperTypeOf(domainElement.eClass()) && isValuePin_3182((ValuePin) domainElement)) {
				return ValuePinInAddStructuralFeatureValueActionAsObjectEditPart.VISUAL_ID;
			}
			if (UMLPackage.eINSTANCE.getValuePin().isSuperTypeOf(domainElement.eClass()) && isValuePin_3183((ValuePin) domainElement)) {
				return ValuePinInAddStructuralFeatureValueActionAsValueEditPart.VISUAL_ID;
			}
			if (UMLPackage.eINSTANCE.getValuePin().isSuperTypeOf(domainElement.eClass()) && isValuePin_3184((ValuePin) domainElement)) {
				return ValuePinInAddStructuralFeatureValueActionAsInserAtEditPart.VISUAL_ID;
			}
			if (UMLPackage.eINSTANCE.getActionInputPin().isSuperTypeOf(domainElement.eClass()) && isActionInputPin_3185((ActionInputPin) domainElement)) {
				return ActionPinInAddStructuralFeatureValueActionAsObjectEditPart.VISUAL_ID;
			}
			if (UMLPackage.eINSTANCE.getActionInputPin().isSuperTypeOf(domainElement.eClass()) && isActionInputPin_3186((ActionInputPin) domainElement)) {
				return ActionPinInAddStructuralFeatureValueActionAsValueEditPart.VISUAL_ID;
			}
			if (UMLPackage.eINSTANCE.getActionInputPin().isSuperTypeOf(domainElement.eClass()) && isActionInputPin_3187((ActionInputPin) domainElement)) {
		...
		case ActivityActivityContentCompartmentEditPart.VISUAL_ID:
			...
			if (UMLPackage.eINSTANCE.getCreateLinkAction().isSuperTypeOf(domainElement.eClass()) && isCreateLinkAction_3117((CreateLinkAction) domainElement)) {
			...
			if (UMLPackage.eINSTANCE.getCreateLinkObjectAction().isSuperTypeOf(domainElement.eClass()) && isCreateLinkObjectAction_3198((CreateLinkObjectAction) domainElement)) {
	...
	public static boolean canCreateNode(View containerView, int nodeVisualID) {
		...
		case ConditionalNodeEditPart.VISUAL_ID:
			...
			if (InputPinInStructuredActivityNodeAsStructuredNodeInputsEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (ValuePinInStructuredActivityNodeAsStructuredNodeInputsEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (ActionPinInStructuredActivityNodeAsStructuredNodeInputsEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (OutputPinInStructuredActivityNodeAsStructuredNodeInputsEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case ExpansionRegionEditPart.VISUAL_ID:
		...
		case LoopNodeEditPart.VISUAL_ID:
			...
			if (ValuePinInLoopNodeAsVariableEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (ActionPinInLoopNodeAsVariableEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
		...
		case ValuePinInLoopNodeAsVariableEditPart.VISUAL_ID:
			if (ValuePinInLoopNodeAsVariableLabelEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (ValuePinInLoopNodeAsVariableValueEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (ValuePinInLoopNodeAsVariableAppliedStereotypeEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case ActionPinInLoopNodeAsVariableEditPart.VISUAL_ID:
			if (ActionPinInLoopNodeAsVariableLabelEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (ActionPinInLoopNodeAsVariableValueEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (ActionPinInLoopNodeAsVariableAppliedStereotypeEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		...
		case InputPinInStructuredActivityNodeAsStructuredNodeInputsEditPart.VISUAL_ID:
			if (InputPinInStructuredActivityNodeAsStructuredNodeInputsLabelEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (InputPinInStructuredActivityNodeAsStructuredNodeInputsAppliedStereotypeEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case ValuePinInStructuredActivityNodeAsStructuredNodeInputsEditPart.VISUAL_ID:
			if (ValuePinInStructuredActivityNodeAsStructuredNodeInputsLabelEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (ValuePinInStructuredActivityNodeAsStructuredNodeInputsValueEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (ValuePinInStructuredActivityNodeAsStructuredNodeInputsAppliedStereotypeEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case ActionPinInStructuredActivityNodeAsStructuredNodeInputsEditPart.VISUAL_ID:
			if (ActionPinInStructuredActivityNodeAsStructuredNodeInputsLabelEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (ActionPinInStructuredActivityNodeAsStructuredNodeInputsValueEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (ActionPinInStructuredActivityNodeAsStructuredNodeInputsAppliedStereotypeEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case OutputPinInStructuredActivityNodeAsStructuredNodeInputsEditPart.VISUAL_ID:
			if (OutputPinInStructuredActivityNodeAsStructuredNodeInputsLabelEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (OutputPinInStructuredActivityNodeAsStructuredNodeInputsAppliedStereotypeEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		...
		case AddStructuralFeatureValueActionEditPart.VISUAL_ID:
			...
			if (InputPinInAddStructuralFeatureValueActionAsInserAtEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (ValuePinInAddStructuralFeatureValueActionAsObjectEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (ValuePinInAddStructuralFeatureValueActionAsValueEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (ValuePinInAddStructuralFeatureValueActionAsInserAtEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (ActionPinInAddStructuralFeatureValueActionAsObjectEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (ActionPinInAddStructuralFeatureValueActionAsValueEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (ActionPinInAddStructuralFeatureValueActionAsInserAtEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
		...
		case InputPinInAddStructuralFeatureValueActionAsInserAtEditPart.VISUAL_ID:
			if (InputPinInAddStructuralFeatureValueActionAsInserAtLabelEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (InputPinInAddStructuralFeatureValueActionAsInserAtAppliedStereotypeWrappingLabelEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case ValuePinInAddStructuralFeatureValueActionAsObjectEditPart.VISUAL_ID:
			if (ValuePinInAddStructuralFeatureValueActionAsObjectLabelEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (ValuePinInAddStructuralFeatureValueActionAsObjectValueEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (ValuePinInAddStructuralFeatureValueActionAsObjectAppliedStereotypeWrappingLabelEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case ValuePinInAddStructuralFeatureValueActionAsValueEditPart.VISUAL_ID:
			if (ValuePinInAddStructuralFeatureValueActionAsValueLabelEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (ValuePinInAddStructuralFeatureValueActionAsValueValueEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (ValuePinInAddStructuralFeatureValueActionAsValueAppliedStereotypeWrappingLabelEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case ValuePinInAddStructuralFeatureValueActionAsInserAtEditPart.VISUAL_ID:
			if (ValuePinInAddStructuralFeatureValueActionAsInserAtLabelEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (ValuePinInAddStructuralFeatureValueActionAsInserAtValueEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (ValuePinInAddStructuralFeatureValueActionAsInserAtAppliedStereotypeWrappingLabelEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case ActionPinInAddStructuralFeatureValueActionAsObjectEditPart.VISUAL_ID:
			if (ActionPinInAddStructuralFeatureValueActionAsObjectLabelEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (ActionPinInAddStructuralFeatureValueActionAsObjectValueEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (ActionPinInAddStructuralFeatureValueActionAsObjectAppliedStereotypeWrappingLabelEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case ActionPinInAddStructuralFeatureValueActionAsValueEditPart.VISUAL_ID:
			if (ActionPinInAddStructuralFeatureValueActionAsValueLabelEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (ActionPinInAddStructuralFeatureValueActionAsValueValueEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (ActionPinInAddStructuralFeatureValueActionAsValueAppliedStereotypeWrappingLabelEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case ActionPinInAddStructuralFeatureValueActionAsInserAtEditPart.VISUAL_ID:
			if (ActionPinInAddStructuralFeatureValueActionAsInserAtLabelEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (ActionPinInAddStructuralFeatureValueActionAsInserAtValueEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (ActionPinInAddStructuralFeatureValueActionAsInserAtAppliedStereotypeWrappingLabelEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		...
		case ActionPinInStartClassifierBehaviorActionAsObjectEditPart.VISUAL_ID:
			...
			break;
		case CreateLinkObjectActionEditPart.VISUAL_ID:
			if (CreateLinkObjectActionNameEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (CreateLinkObjectActionFloatingNameEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (InputPinInCreateLinkObjectActionAsInputValueEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (ValuePinInCreateLinkObjectActionAsInputValueEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (ActionPinInCreateLinkObjectActionAsInputValueEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (OutputPinInCreateLinkObjectActionEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case InputPinInCreateLinkObjectActionAsInputValueEditPart.VISUAL_ID:
			if (InputPinInCreateLinkObjectActionAsInputValueLabelEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (InputPinInCreateLinkObjectActionAsInputValueAppliedStereotypeLabelEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case ValuePinInCreateLinkObjectActionAsInputValueEditPart.VISUAL_ID:
			if (ValuePinInCreateLinkObjectActionAsInputValueLabelEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (ValuePinInCreateLinkObjectActionAsInputValueValueEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (ValuePinInCreateLinkObjectActionAsInputValueAppliedStereotypeLabelEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case ActionPinInCreateLinkObjectActionAsInputValueEditPart.VISUAL_ID:
			if (ActionPinInCreateLinkObjectActionAsInputValueLabelEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (ActionPinInCreateLinkObjectActionAsInputValueValueEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (ActionPinInCreateLinkObjectActionAsInputValueAppliedStereotypeLabelEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case OutputPinInCreateLinkObjectActionEditPart.VISUAL_ID:
			if (OutputPinInCreateLinkObjectActionLabelEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (OutputPinInCreateLinkObjectActionAppliedStereotypeLabelEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case ActivityActivityParametersCompartmentEditPart.VISUAL_ID:
		...
		case ActivityActivityContentCompartmentEditPart.VISUAL_ID:
			...
			if (CreateLinkObjectActionEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case ConditionalNodeStructuredActivityNodeContentCompartmentEditPart.VISUAL_ID:
