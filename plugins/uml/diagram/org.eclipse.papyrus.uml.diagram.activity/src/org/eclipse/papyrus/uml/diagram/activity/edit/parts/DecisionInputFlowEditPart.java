 ...
 * @generated
 */
public class DecisionInputFlowEditPart extends PapyrusLabelEditPart implements ITextAwareEditPart, IControlParserForDirectEdit, ILabelRoleProvider {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.papyrus.uml.diagram.activity.edit.parts.DecisionInputFlowEditPart.VISUAL_ID), new Point(0, -20));
	}

	/**
	 * @generated
	 */
	public DecisionInputFlowEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.ObjectFlow_4003, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.uml.diagram.activity.edit.parts.DecisionInputFlowEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	public String getLabelRole() {
		return "DecisionInputFlow";//$NON-NLS-1$
	}
