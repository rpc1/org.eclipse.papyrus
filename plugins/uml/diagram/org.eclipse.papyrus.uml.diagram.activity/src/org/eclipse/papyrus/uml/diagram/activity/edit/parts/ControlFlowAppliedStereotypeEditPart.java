 ...
 * @generated
 */
public class ControlFlowAppliedStereotypeEditPart extends PapyrusLabelEditPart implements ITextAwareEditPart, IControlParserForDirectEdit, ILabelRoleProvider {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.papyrus.uml.diagram.activity.edit.parts.ControlFlowAppliedStereotypeEditPart.VISUAL_ID), new Point(0, -20));
	}

	/**
	 * @generated
	 */
	public ControlFlowAppliedStereotypeEditPart(View view) {
		super(view);
	}
	...
	/**
	 * @generated NOT use WrappingLabel
	 */
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.ControlFlow_4004, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.uml.diagram.activity.edit.parts.ControlFlowAppliedStereotypeEditPart.VISUAL_ID));
		}
		return parser;
	}
