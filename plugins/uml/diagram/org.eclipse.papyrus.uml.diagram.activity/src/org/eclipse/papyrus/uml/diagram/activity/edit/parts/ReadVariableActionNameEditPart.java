 ...
 * @generated
 */
public class ReadVariableActionNameEditPart extends PapyrusCompartmentEditPart implements ITextAwareEditPart, IControlParserForDirectEdit {
	 ...
	 * @generated
	 */
	public ReadVariableActionNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.ReadVariableAction_3097, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.uml.diagram.activity.edit.parts.ReadVariableActionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
