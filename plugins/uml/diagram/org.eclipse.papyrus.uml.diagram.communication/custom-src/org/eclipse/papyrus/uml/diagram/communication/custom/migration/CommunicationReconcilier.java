 ...
 */
public class CommunicationReconcilier extends DiagramReconciler {
	...
	private Map<String, String> getFloatingLabelMap() {
		...
		map.put(String.valueOf(InteractionEditPart.VISUAL_ID), String.valueOf(InteractionFloatingLabelEditPart.VISUAL_ID));
		map.put(String.valueOf(LifelineEditPartCN.VISUAL_ID), String.valueOf(LifelineFloatingLabelEditPartCN.VISUAL_ID));
