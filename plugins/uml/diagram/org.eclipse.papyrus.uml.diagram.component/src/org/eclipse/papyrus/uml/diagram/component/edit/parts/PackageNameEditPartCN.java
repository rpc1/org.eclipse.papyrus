...
public class PackageNameEditPartCN extends PapyrusCompartmentEditPart implements ITextAwareEditPart,
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Package_3076, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.uml.diagram.component.edit.parts.PackageNameEditPartCN.VISUAL_ID));
		}
		return parser;
	}
