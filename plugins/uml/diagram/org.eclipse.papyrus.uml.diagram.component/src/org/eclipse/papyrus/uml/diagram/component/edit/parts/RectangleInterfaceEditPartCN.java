 ...
 * @generated
 */
public class RectangleInterfaceEditPartCN extends RoundedCompartmentEditPart {
	 ...
	 * @generated
	 */
	public RectangleInterfaceEditPartCN(View view) {
		super(view);
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof RectangleInterfaceNameEditPartCN) {
			((RectangleInterfaceNameEditPartCN) childEditPart).setLabel(getPrimaryShape().getNameLabel());
			return true;
		}
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof RectangleInterfaceFloatingLabelEditPartCN) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(RectangleInterfaceNameEditPartCN.VISUAL_ID));
	}
