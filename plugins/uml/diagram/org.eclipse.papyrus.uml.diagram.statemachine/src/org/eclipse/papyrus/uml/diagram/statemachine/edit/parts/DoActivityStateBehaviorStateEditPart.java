...
public class DoActivityStateBehaviorStateEditPart extends CompartmentEditPart implements ITextAwareEditPart, IPrimaryEditPart, IControlParserForDirectEdit {
	 ...
	 * @generated
	 */
	public static final int VISUAL_ID = 691;
	 ...
	 * @generated
	 */
	public DoActivityStateBehaviorStateEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Behavior_691, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.uml.diagram.statemachine.edit.parts.DoActivityStateBehaviorStateEditPart.VISUAL_ID));
		}
		return parser;
	}
