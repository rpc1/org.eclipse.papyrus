...
public class EntryStateBehaviorEditPart extends CompartmentEditPart implements ITextAwareEditPart, IPrimaryEditPart, IControlParserForDirectEdit {
	 ...
	 * @generated
	 */
	public static final int VISUAL_ID = 690;
	 ...
	 * @generated
	 */
	public EntryStateBehaviorEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Behavior_690, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.uml.diagram.statemachine.edit.parts.EntryStateBehaviorEditPart.VISUAL_ID));
		}
		return parser;
	}
