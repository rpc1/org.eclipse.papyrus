	...
	public void performDirectEditRequest(Request request) {
		...
		if (configuration == null || configuration.getLanguage() == null) {
			...
			if (configuration instanceof ICustomDirectEditorConfiguration) {
				...
				dialog = new ExtendedDirectEditionDialog(PlatformUI.getWorkbench().getActiveWorkbenchWindow().getShell(), gep.resolveSemanticElement(), configuration.getTextToEdit(gep.resolveSemanticElement()), configuration);
			} else {
				return;
			}
