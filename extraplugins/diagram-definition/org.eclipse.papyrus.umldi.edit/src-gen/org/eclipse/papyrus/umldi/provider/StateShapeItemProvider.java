...
public class StateShapeItemProvider extends BaseStateShapeItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if(childrenFeatures == null) {
			...
			childrenFeatures.add(UMLDIPackage.Literals.STATE_SHAPE__DEFERRABLE_TRIGGER_COMPARTMENT);
			childrenFeatures.add(UMLDIPackage.Literals.STATE_SHAPE__INTERNAL_BEHAVIOR_COMPARTMENT);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/StateShape"));
	}
